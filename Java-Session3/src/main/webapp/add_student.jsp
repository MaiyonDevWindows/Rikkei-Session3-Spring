        ...
        <div class="col-lg-6">
            <form action="/student" method="post">
                <div class="form-group">
                    <label for="student-id">MSV</label>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <label class="form-check-label">
                            <input class="form-check-input" type="radio" name="gender" checked value="true"> Trai
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <label class="form-check-label">
                            <input class="form-check-input" type="radio" name="gender" value="false"> Gái
                        </label>
                    </div>
                </div>
